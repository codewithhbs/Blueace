...
function EditMainServiceCategory() {
    ...
    const handleFetchData = async () => {
        try {
            const {data} = await axios.get(`https://api.blueaceindia.com/api/v1/get-single-service-main-category/${id}`) 
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.blueaceindia.com/api/v1/update-service-main-category/${id}`,payload,{
                headers: {
