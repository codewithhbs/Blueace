...
const EditTestVideo = () => {
    ...
    useEffect(() => {
        const fetchVideo = async () => {
            try {
                const { data } = await axios.get(`https://api.blueaceindia.com/api/v1/get-test-video`);
                const res = data.data;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.blueaceindia.com/api/v1/update-test-video/${id}`, form, {
