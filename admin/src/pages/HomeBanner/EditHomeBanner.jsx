...
function EditHomeBanner() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const { data } = await axios.get(`https://api.blueaceindia.com/api/v1/get-single-banner/${id}`)
                const res = data.data;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.blueaceindia.com/api/v1/update-banner/${id}`, payload, {
                headers: {
    ...
    return (
        <div>
            <Breadcrumb heading={'Home Layout'} subHeading={'All Banner'} LastHeading={'Edit Banner'} backLink={'/home-layout/all-banner'} />
