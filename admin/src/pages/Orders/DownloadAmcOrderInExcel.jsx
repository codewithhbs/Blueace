...
const DownloadAmcOrderInExcel = () => {
    ...
    const fetchVendorDetail = async () => {
        ...
        try {
            ...
            console.log("vendorsData",allVenodrOrder);
            // const vendorOrder = allVenodrOrder.filter((item) => item?.vendorAlloted?.Role === "employ");
            const filternotSelectAmc = allVenodrOrder.filter((item) => item?.userId?.isAMCUser === true);
...
export default DownloadAmcOrderInExcel
