...
const EditUser = () => {
    ...
    const fetchExistingUser = async () => {
        try {
            const { data } = await axios.get(`https://www.api.blueaceindia.com/api/v1/get-single-user/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.put(`https://www.api.blueaceindia.com/api/v1/update-user/${id}`, Payload, {
