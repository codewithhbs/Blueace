...
const AllJobInquiry = () => {
    ...
    const handleFetchData = async () => {
        setLoading(true);
        try {
            const response = await axios.get('https://api.blueaceindia.com/api/v1/get-all-career-inquiry');
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://api.blueaceindia.com/api/v1/delete-career-inquiry/${id}`);
            if (response.data.success) {
